...
# Add test_fio executable
add_executable(test_fio ${BKA_TEST}/test_fio.c)
target_link_libraries(test_fio callback crtso io libumps string utils)
...
apply_elf2umps(test0 test1 test2 test3 test_fio unit_test)
