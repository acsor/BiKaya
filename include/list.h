 ...
 * lista.
 * __mptr non è altro che una copia di ptr con il tipo del campo member;
 * l'indirizzo della struttura si ottiene poi sottraendo a __mptr l'offset
 * del campo in questione, usando la macro offsetof.
 *
 * @param ptr: puntatore al list_head della struttura dati di cui si vuole
 * ottenere il puntatore
 * @param type: tipo della struttura che contiene list_head e di cui si vuole
 * ottenere un puntatore
 * @param member: nome della variabile di tipo list_head contenuta come campo
 * nella struttura
 *
